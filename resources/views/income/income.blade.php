            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="{{ url('/income/save') }}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <table class="table table-striped table-bordered table-hover tableIncome">
                            <thead>
                                <tr>
                                    <th>Description</th>
                                    <th>Amount</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($income->currency == "mainCurrency")
                                            <span class="currency1">{{ $income->amount }}</span>
                                        @else
                                            <span class="currency2">{{ $income->amount }}</span>
                                        @endif
                                    </td>
                                    <td style="text-transform:capitalize">{{ $income->frequency }}</td>
                                    <td>{{ $nextPayment[$income->id] }}</td>
                                    <td style="text-transform:capitalize">{{ $income->type }}</td>
                                    <td style="text-align:center"><a href="/income/{{ $income->id }}" class="btn btn-primary">Details</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
